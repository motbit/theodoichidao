...
@section('content')
    ...
    <div>
        <span><a class="btn btn-default buttons-excel buttons-html5" tabindex="0" aria-controls="table" href="javascript:exportReportExcel()"><span>Xuất ra Excel</span></a></span>
