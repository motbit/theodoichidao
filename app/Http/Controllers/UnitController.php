...
//            return view("unit/update")->with('unit', $unit, 'data' => $data);
    ...
    public function update(Request $request)
    {
        ...
        if ($id > 0) {
            ...
            MLogs::write(Constant::$ACTION_UPDATE, 'unit', $request->input('id'), '');
            ...
            $result = Unit::insertGetId([
                'name' => $request->input('name'),
                'description' => $request->input('description'),
                'shortname' => $request->input('shortname'),
                'parent_id' => $request->input('parent_id'),
            ]);
            MLogs::write(Constant::$ACTION_CREATE, 'unit', $result, '');
            return redirect()->action(
    ...
    public function delete(Request $request)
    {
        ...
        if ($st_count > 0) {
            ...
            MLogs::write(Constant::$ACTION_DELETE, 'unit', $id, 'Delete unit: ' . $unit->name);
        }
